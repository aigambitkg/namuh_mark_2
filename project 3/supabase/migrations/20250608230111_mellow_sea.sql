...
-- Create RLS policies for forum tables using DO blocks to check if they exist first
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'forum_groups' 
    AND policyname = 'Everyone can see forum groups'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Everyone can see forum posts'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'forum_posts' 
    AND policyname = 'Users can create forum posts'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'forum_post_votes' 
    AND policyname = 'Users can vote on posts once'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'forum_post_votes' 
    AND policyname = 'Users can see votes'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Everyone can see comments'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'job_external_posting_platforms' 
    AND policyname = 'Everyone can read job platforms'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'job_external_postings' 
    AND policyname = 'Recruiters can see their job external postings'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'multiposting_campaigns' 
    AND policyname = 'Recruiters can manage their campaigns'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'company_update_items' 
    AND policyname = 'Everyone can see published company updates'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'company_update_items' 
    AND policyname = 'Recruiters can manage their company updates'
  ) THEN
...
-- Reordered parameters so that those without defaults come first
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'applicant_educations' 
    AND policyname = 'Applicants can manage their own education'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'applicant_experiences' 
    AND policyname = 'Applicants can manage their own experience'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'applicant_certifications' 
    AND policyname = 'Applicants can manage their own certifications'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'applicant_educations' 
    AND policyname = 'Recruiters can see public applicant educations'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'applicant_experiences' 
    AND policyname = 'Recruiters can see public applicant experiences'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'applicant_certifications' 
    AND policyname = 'Recruiters can see public applicant certifications'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Recruiters can manage their own templates'
  ) THEN
